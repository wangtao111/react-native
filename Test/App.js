...
const MyTab = TabNavigator({
    Test1: {
        ...
        navigationOptions:({navigation,screenProps}) => ({
            ...
            tabBarLabel:'导航一', // 设置标签栏的title。推荐这个方式。
        })
    },
    Test2: {
        screen:Test2,
    ...
    Test3:{
        screen:Test3,
        navigationOptions: ()=> TabOptions('导航三',MainIcon,MainIcon,'导航三'),
    },
},{
    ...
    tabBarOptions:{
        ...
        // showLabel:true, //是否显示label，默认开启。
        // style:{}, // tabbar的样式。
        labelStyle:{fontSize: 10}, // label的样式。
        upperCaseLabel:false, // 是否使标签大写，默认为true。
        pressColor:'#111', // material涟漪效果的颜色（安卓版本需要大于5.0）。
