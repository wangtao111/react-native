...
export default class Test2 extends Component {
    ...
    static navigationOptions = ({navigation,screenProps}) => ({
        ...
        headerTitle:navigation.state.params?navigation.state.params.headerTitle:'导航二',
        tabBarLabel:navigation.state.params?navigation.state.params.tabBarLabel:'导航二',
